def help():
    ...
    1. Allow user to define hyperlinks in target folder structure e.g. references in network directories to reduce size of root directories and avoid issues associated with duplicate files
    2. Allow user to define symbolic links in target folder structure e.g. link libraries to avoid issues associated with duplicate files
